...
export function Container05() {
    return (
        
        <div className="bg-gradient-to-r from-purple-600 to-blue-600 items-center flex flex-col md:flex-row p-[55px] font-sans text-justify">

            <div className="p-12 sm:w-full md:w-full lg:w-full xl:w-2/4">
                <Image className="shadow-custom-dark" src={Container03img} alt="mulher conversando no celular" />
            </div>

            <div className="text-white p-3 sm:w-full md:w-full lg:w-full xl:w-2/4">
